...
# Task with hardcoded values and no concern for months
...
# Task with user input and taking into consideration whether they've had their birthday this year yet
...
# Using datetime to also output the number of hours they've been alive
